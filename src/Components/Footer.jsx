...
const Footer = () => {
  return (
    ...
    <div className="relative mt-16 md:mt-32 pt-[6em] " id="foot">
      ...
      className="absolute w-[7em] h-[8em] top-0 right-0 fmount1 " src={fmount} alt="" />
      <motion.img
      initial={{ opacity: 0 , y:0 }}
      whileInView={{ opacity: 1,y:-1  }}
      transition={{ delay: 0.8, duration: 0.7 }}
       className="absolute w-[6em] h-[8em] top-0 fmount " src={fmount1} alt="" /> 
        ...
        <div className="  bg-[#3A281E] flex justify-center w-screen h-full overflow-x-hidden ">
          ...
          <div className="container bg-[#3A281E] max-w-[87em] mx-auto mt-3 ">
            <div className=" py-4 md:py-8 px-2 md:px-20 flex flex-col sm:flex-row justify-between items-center w-full">
              ...
              <div className=" flex flex-row md:gap-6 gap-4 pt-3  px-2 justify-center">
                <div className=" ">
                  <p className=" text-white "> Ayush Kumar</p>
                  <p className=" text-white text-[0.9em] "> (Secretary)</p>
                  <p className="text-white flex items-center gap-1 mt-3 "><FaPhone/>9898XXXXXX</p>
