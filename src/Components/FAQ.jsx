...
const FAQ = () => {
  return (
    <div className='mt-[6em] max-w-[87em] relative overflow-hidden gradi w-[91%] mx-auto flex flex-col lg:gap-8 gap:2 px-6 border-[#A46B3A] pb-[3.50em] border-[3.5px] rounded-2xl'>
      ...
      <img className='absolute w-[30em] -left-[5em] top-[26%] md:top-[24%] ' src={asd} alt="" />
      <img className='absolute w-[80em] hidden md:block left-[20em] top-[23%]' src={asd2} alt="" />

      <img className='w-[9em] mx-auto relative z-10 py-6 mb-[5em]' src={Faq} alt="" />
      <div className='flex flex-col lg:gap-10  z-10'>
      ...
      <img className='w-[14em] md:w-[16em] absolute question' src={questionmark} alt="" />
